...
namespace veasu.noisegate {
  [PluginType(Id = "com.veasu.noisegateplugin", 
  Name = "Noise Gate Plugin", 
  Description = "Small basic noise gate that can be used to filter background noise for lipsync node", 
  Author = "Veasu", 
  Version = "0.1.0", 
  ...
  NodeTypes = new System.Type[] {typeof (NoiseGateNode)})]
  public class NoiseGatePlugin : Plugin
  {
  }
}
